...
public class Tech extends Card
{
     ...
     * in the following format (example uses ";" as a deliminator) name;cost;numberAvalable;description*/
    public Tech(String line , String delim){
        ...
        try{
            ...
            System.err.println(classMsg+numberAvalable+": Cannot parse numberAvalable to int");
        }
    }
