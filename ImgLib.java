...
public class ImgLib {
    ...
    public static void ImageLibrary() {
        ...
        // Images for the viewTechScreen
        viewTech = toolkit
                .getImage("resources/images/backgrounds/viewTechScreen.png");

        woodBackground = toolkit
                .getImage("resources/images/backgrounds/Woodbackground.png");
        ...
        // Images for the viewDestScreen
        viewDest = toolkit
                .getImage("resources/images/backgrounds/viewDestScreen.png");
        // City Hover images
        emptyHover = toolkit
                .getImage("resources/images/cityHover/emptyHover.png");
        stornowayHover = toolkit
                .getImage("resources/images/cityHover/stornowayHover.png");
        ullapoolHover = toolkit
                .getImage("resources/images/cityHover/ullapoolHover.png");
        wickHover = toolkit
                .getImage("resources/images/cityHover/wickHover.png");
        fortwilliamHover = toolkit
                .getImage("resources/images/cityHover/fortwilliamHover.png");
        invernessHover = toolkit
                .getImage("resources/images/cityHover/invernessHover.png");
        aberdeenHover = toolkit
                .getImage("resources/images/cityHover/aberdeenHover.png");
        londonderryHover = toolkit
                .getImage("resources/images/cityHover/londonderryHover.png");
        glasgowHover = toolkit
                .getImage("resources/images/cityHover/glasgowHover.png");
        edinburghHover = toolkit
                .getImage("resources/images/cityHover/edinburghHover.png");
        dundeeHover = toolkit
                .getImage("resources/images/cityHover/dundeeHover.png");
        sligoHover = toolkit
                .getImage("resources/images/cityHover/sligoHover.png");
        belfastHover = toolkit
                .getImage("resources/images/cityHover/belfastHover.png");
        stranraerHover = toolkit
                .getImage("resources/images/cityHover/stranraerHover.png");
        galwayHover = toolkit
                .getImage("resources/images/cityHover/galwayHover.png");
        dundalkHover = toolkit
                .getImage("resources/images/cityHover/dundalkHover.png");
        carlisleHover = toolkit
                .getImage("resources/images/cityHover/carlisleHover.png");
        newcastleHover = toolkit
                .getImage("resources/images/cityHover/newcastleHover.png");
        limerickHover = toolkit
                .getImage("resources/images/cityHover/limerickHover.png");
        tullamoreHover = toolkit
                .getImage("resources/images/cityHover/tullamoreHover.png");
        dublinHover = toolkit
                .getImage("resources/images/cityHover/dublinHover.png");
        barrowsHover = toolkit
                .getImage("resources/images/cityHover/barrowsHover.png");
        corkHover = toolkit
                .getImage("resources/images/cityHover/corkHover.png");
        rosslareHover = toolkit
                .getImage("resources/images/cityHover/rosslareHover.png");
        hollyheadHover = toolkit
                .getImage("resources/images/cityHover/hollyheadHover.png");
        liverpoolHover = toolkit
                .getImage("resources/images/cityHover/liverpoolHover.png");
        leedsHover = toolkit
                .getImage("resources/images/cityHover/leedsHover.png");
        aberystrythHover = toolkit
                .getImage("resources/images/cityHover/aberystrythHover.png");
        manchesterHover = toolkit
                .getImage("resources/images/cityHover/manchesterHover.png");
        hullHover = toolkit
                .getImage("resources/images/cityHover/hullHover.png");
        carmarthenHover = toolkit
                .getImage("resources/images/cityHover/carmarthenHover.png");
        llandrindodwellsHover = toolkit.getImage(
                "resources/images/cityHover/llandrindodwellsHover.png");
        birminghamHover = toolkit
                .getImage("resources/images/cityHover/birminghamHover.png");
        nottinghamHover = toolkit
                .getImage("resources/images/cityHover/nottinghamHover.png");
        cardiffHover = toolkit
                .getImage("resources/images/cityHover/cardiffHover.png");
        northamptonHover = toolkit
                .getImage("resources/images/cityHover/northamptonHover.png");
        cambridgeHover = toolkit
                .getImage("resources/images/cityHover/cambridgeHover.png");
        norwichHover = toolkit
                .getImage("resources/images/cityHover/norwichHover.png");
        penzanceHover = toolkit
                .getImage("resources/images/cityHover/penzanceHover.png");
        plymouthHover = toolkit
                .getImage("resources/images/cityHover/plymouthHover.png");
        bristolHover = toolkit
                .getImage("resources/images/cityHover/bristolHover.png");
        readingHover = toolkit
                .getImage("resources/images/cityHover/readingHover.png");
        londonHover = toolkit
                .getImage("resources/images/cityHover/londonHover.png");
        ipswichHover = toolkit
                .getImage("resources/images/cityHover/ipswichHover.png");
        southamptonHover = toolkit
                .getImage("resources/images/cityHover/southamptonHover.png");
        brightonHover = toolkit
                .getImage("resources/images/cityHover/brightonHover.png");
        doverHover = toolkit
                .getImage("resources/images/cityHover/doverHover.png");
        franceHover = toolkit
                .getImage("resources/images/cityHover/franceHover.png");
