...
public class GamePanel extends JPanel{
    ...
    public GamePanel(ArrayList<Player> players)
    {
        ...
        //adds JLabel component with MouseListener's for every city in GameBoard
    ...
    public ArrayList<Card> purchaseTechCards(){
        ...
        GButton purchaseButt = new GButton(new int[]{543,828,174,51},ImgLib.purchaseButtonUnselected,ImgLib.purchaseButtonHighlighted);
    ...
    /**
     * method to present the player with a list of Dest Cards to choose from, unselected cards are added to gameBoard.destDeck.discard
     * 
    ...
    public ArrayList<Card> selectDestCards(String title,int minimum, int limit , int numberOfCards){
        ...
        GButton selectButt = new GButton(new int[]{543,828,174,51},ImgLib.selectButtonUnselected,ImgLib.selectButtonHighlighted);
    ...
    public void paintComponent( Graphics g )
    {
        ...
        for(City c : gameBoard.cities){
            ...
            if(c.hover)
                g.drawImage(ImgLib.getHover(c.name), c.x-87, (c.y+yOFFSET)-60, this);
        }
        drawPlayerHand(g);
        drawPlayerInfo(g);
